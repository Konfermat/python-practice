...
class Cache:
    ...
    def _clear_cache_expire(self, cache_data):
    ...
    def __call__(self, *args, **kwargs):
        ...
        cache_data = self._clear_cache_expire(cache_data)
        ...
        print(f'вычеслен результат для {self.func.__name__}{args}')
        return result
...
print('вызов (3, 5000, mul)')
start_time = time.time()
#res1 = example(3, 5, 'mul')
res1 = example(3, 5000, 'mul')
